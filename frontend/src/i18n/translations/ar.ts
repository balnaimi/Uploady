export default {
  ...
  "home.bullet.a.description": "قم باستضافة Uplody على جهازك.",
  "home.bullet.b.name": "الخصوصية",
  "home.bullet.b.description": "ملفاتك ملكك ولن يتمكن أي طرف ثالث من الوصول إليها.",
  "home.bullet.c.name": "ليس هناك أية قيود على حجم الملفات",
  "home.bullet.c.description": "ارفع ملفات بأي حجم تريده. القرص الصلب فقط سيكون حدك.",
  ...
  "signIn.oauth.or": "أو",
  "signIn.oauth.signInWith": "تسجيل الدخول بواسطة",
  ...
  // END /auth/signup
  // /auth/totp
  "totp.title": "المصادقة الثنائية TOTP",
  ...
  "resetPassword.notify.success": "تم إرسال رسالة تحتوي على رابط لإعادة تعيين كلمة السر إذا كان البريد الإلكتروني المقدم موجودًا.",
  ...
  "resetPassword.notify.passwordReset": "تم إعادة تعيين كلمة السر بنجاح.",
  // /account
  "account.title": "حسابي",
  ...
  "account.card.password.noPasswordSet": "لم تقم بتعيين كلمة سر. لتسجيل الدخول باستخدام بريدك وكلمة السر، تحتاج إلى إنشاء كلمة سر.",
  ...
  "account.modal.unlink.description": "فك ربط حساباتك الاجتماعية قد يؤدي إلى فقدان حسابك إذا كنت لا تتذكر بيانات تسجيل الدخول",
  ...
  "account.shares.table.password-protected": "محمي بكلمة سر",
  ...
  "account.reverseShares.modal.simplified": "الوضع المبسط",
  "account.reverseShares.modal.simplified.description": "يسهل على الشخص الذي يرفع الملف مشاركته معك. سيكون قادرًا فقط على تخصيص اسم ووصف المشاركة.",
  "account.reverseShares.modal.public-access": "الوصول العام",
  "account.reverseShares.modal.public-access.description": "اجعل المشاركات التي تم إنشاؤها باستخدام هذه المشاركة العكسية عامة. إذا تم تعطيله، فأنت ومنشئ المشاركة فقط سيكون لديكم إمكانية الوصول لعرضها.",
  ...
  "account.reverseShares.table.expires": "ينتهي في",
  ...
  "admin.users.edit.delete.description": "هل تريد حقاً حذف هذا المستخدم وجميع مشاركاته؟",
  ...
  // /upload
  "upload.title": "رفع",
  "upload.notify.confirm-leave": "هل أنت متأكد أنك تريد مغادرة هذه الصفحة؟ سيتم إلغاء رفعك.",
  ...
  "upload.reverse-share.error.invalid.title": "رابط المشاركة العكسية غير صحيح",
  "upload.reverse-share.error.invalid.description": "انتهت صلاحية هذه المشاركة العكسية أو أنها غير صحيحة.",
  // Dropzone.tsx
  "upload.dropzone.title": "رفع الملفات",
  "upload.dropzone.description": "اسحب وأفلت الملفات هنا لبدء مشاركتك. نقبل فقط ملفات يصل إجمالي حجمها إلى {maxSize}.",
  ...
  "upload.modal.completed.notified-reverse-share-creator": "لقد أبلغنا منشئ المشاركة العكسية. يمكنك أيضًا مشاركة هذا الرابط معهم يدويًا من خلال وسائل أخرى.",
  // END /upload
  // /share/[id]
  ...
  "share.modal.password.description": "الرجاء إدخال كلمة السر للوصول إلى هذه المشاركة.",
  "share.modal.password": "كلمة السر",
  "share.modal.error.invalid-password": "كلمة السر غير صحيحة",
  "share.button.download-all": "تنزيل الكل",
  "share.notify.download-all-preparing": "يتم تحضير المشاركة. الرجاء المحاولة مرة أخرى بعد بضع دقائق.",
  ...
  "share.modal.file-preview.error.not-supported.description": "المعاينة غير مدعومة لهذا النوع من الملفات. الرجاء تنزيل الملف لعرضه.",
  // END /share/[id]
  // /share/[id]/edit
  ...
  "admin.config.config-file-warning.description": "نظرًا لأن لديك Uplody مُكوّنًا بملف تكوين، لا يمكنك تغيير التكوين من خلال واجهة المستخدم.",
  "admin.config.title": "الإعدادات",
  "admin.config.category.general": "عام",
  "admin.config.category.share": "مشاركة",
  "admin.config.category.cache": "الذاكرة المؤقتة",
  ...
  "admin.config.general.app-url.description": "الرابط الذي تكون مشاركة Uplody صالحة عليه",
  "admin.config.general.secure-cookies": "ملفات تعريف الارتباط الآمنة",
  "admin.config.general.secure-cookies.description": "ما إذا كان سيتم تعيين علامة الأمان على ملفات تعريف الارتباط. إذا تم تفعيله، لن يعمل الموقع عند الوصول إليه عبر HTTP.",
  ...
  "admin.config.general.session-duration.description": "الوقت الذي يجب بعدها على المستخدم تسجيل الدخول مرة أخرى (افتراضيًا: 3 أشهر).",
  ...
  "admin.config.cache.ttl.description": "الوقت بالثواني للاحتفاظ بالمعلومات داخل الذاكرة المؤقتة.",
  "admin.config.cache.max-items": "الحد الأقصى للعناصر",
  "admin.config.cache.max-items.description": "الحد الأقصى لعدد العناصر داخل الذاكرة المؤقتة.",
  "admin.config.cache.redis-enabled": "تفعيل Redis",
  "admin.config.cache.redis-enabled.description": "عادةً ما يقوم Uplody بتخزين المعلومات في الذاكرة. إذا قمت بتشغيل عدة مثيلات من Uplody، تحتاج إلى تفعيل تخزين Redis لمشاركة الذاكرة المؤقتة بين المثيلات.",
  "admin.config.cache.redis-url": "رابط Redis",
  "admin.config.cache.redis-url.description": "الرابط للاتصال بمثيل Redis المستخدم للتخزين المؤقت.",
  "admin.config.email.enable-share-email-recipients": "تفعيل مشاركة مستلمي البريد الإلكتروني",
  "admin.config.email.enable-share-email-recipients.description": "ما إذا كان سيتم السماح بمشاركة البريد الإلكتروني مع المستلمين. قم بتفعيل هذا فقط إذا كان SMTP مفعّلًا.",
  ...
  "admin.config.email.share-recipients-message.description": "الرسالة التي تُرسل لمستقبِلي المشاركة. المتغيرات المتاحة:\n {creator} - اسم المستخدم لمنشئ المشاركة\n {creatorEmail} - بريد منشئ المشاركة\n {shareUrl} - رابط المشاركة\n {desc} - وصف المشاركة\n {expires} - تاريخ انتهاء صلاحية المشاركة\n سيتم استبدال هذه المتغيرات بالقيمة الفعلية.",
  "admin.config.email.reverse-share-subject": "عنوان المشاركة العكسية",
  "admin.config.email.reverse-share-subject.description": "عنوان البريد الإلكتروني المرسل عندما ينشئ شخص ما مشاركة باستخدام رابط المشاركة العكسية الخاص بك.",
  ...
  "admin.config.email.reset-password-subject.description": "عنوان البريد الإلكتروني المرسل عندما يطلب المستخدم إعادة تعيين كلمة السر.",
  ...
  "admin.config.email.invite-subject.description": "عنوان البريد الإلكتروني المرسل عندما يدعو المدير مستخدمًا.",
  "admin.config.email.invite-message": "رسالة الدعوة",
  "admin.config.email.invite-message.description": "الرسالة التي تُرسل عندما يدعو المدير مستخدمًا. سيتم استبدال {url} برابط الدعوة، و{email} بالبريد الإلكتروني و{password} بكلمة سر المستخدم.",
  ...
  "admin.config.share.max-expiration.description": "أقصى مدة لانتهاء صلاحية المشاركة. اضبط على 0 للسماح بانتهاء صلاحية غير محدود.",
  "admin.config.share.share-id-length": "الطول الافتراضي لمعرّف المشاركة",
  "admin.config.share.share-id-length.description": "الطول الافتراضي للمعرّف المُنشأ للمشاركة. تُستخدم هذه القيمة أيضًا لإنشاء روابط للمشاركات العكسية. القيمة الأقل من 8 لا تعتبر آمنة.",
  ...
  "admin.config.share.chunk-size.description": "اضبط حجم القطعة لرفعاتك لتحقيق التوازن بين الكفاءة والموثوقية وفقًا لاتصالك بالإنترنت. القطع الأصغر يمكن أن تعزز معدلات النجاح للاتصالات غير المستقرة، بينما القطع الأكبر تجعل الرفعات أسرع للاتصالات المستقرة.",
  "admin.config.share.auto-open-share-modal": "فتح نافذة إنشاء المشاركة تلقائيًا",
  "admin.config.share.auto-open-share-modal.description": "تظهر نافذة إنشاء المشاركة تلقائيًا عندما يختار المستخدم ملفات، مما يلغي الحاجة للنقر يدويًا على الزر.",
  "admin.config.smtp.enabled": "تفعيل",
  ...
  "admin.config.smtp.email.description": "عنوان البريد الإلكتروني الذي تُرسل منه الرسائل",
  ...
  "admin.config.smtp.allow-unauthorized-certificates": "الثقة في شهادات خادم SMTP غير المصرح بها",
  "admin.config.smtp.allow-unauthorized-certificates.description": "اضبط هذا على true فقط إذا كنت بحاجة للثقة في الشهادات الموقعة ذاتيًا.",
  ...
  "admin.config.oauth.disable-password.description": "ما إذا كان سيتم تعطيل تسجيل الدخول بكلمة السر\nتأكد من تكوين موفر OAuth بشكل صحيح قبل تفعيل هذا الإعداد لتجنب إغلاق الحساب.",
  "admin.config.oauth.github-enabled": "GitHub",
  "admin.config.oauth.github-enabled.description": "تفعيل خيار الدخول بحساب GitHub",
  "admin.config.oauth.github-client-id": "معرّف عميل GitHub",
  ...
  "admin.config.oauth.google-client-id": "معرّف عميل Google",
  ...
  "admin.config.oauth.microsoft-tenant": "مستأجر Microsoft",
  "admin.config.oauth.microsoft-tenant.description": "معرف المستأجر لتطبيق Microsoft OAuth\nالشائع: يمكن للمستخدمين الذين لديهم حساب Microsoft شخصي وحساب عمل أو مدرسة من Microsoft Entra ID أن يسجلوا الدخول إلى التطبيق. المؤسسات: يمكن فقط للمستخدمين الذين لديهم حسابات عمل أو مدرسة من Microsoft Entra ID تسجيل الدخول إلى التطبيق.\nالمستهلكون: يمكن فقط للمستخدمين الذين لديهم حساب Microsoft الشخصي تسجيل الدخول إلى التطبيق.\nاسم نطاق مستأجر Microsoft Entra أو معرف المستأجر بتنسيق GUID: يمكن فقط للمستخدمين من مستأجر Microsoft Entra محدد (أعضاء الدليل الذين لديهم حساب عمل أو مدرسة أو ضيوف الدليل الذين لديهم حساب شخصي لـ Microsoft) تسجيل الدخول إلى التطبيق.",
  "admin.config.oauth.microsoft-client-id": "معرّف عميل Microsoft",
  ...
  "admin.config.oauth.discord-limited-users.description": "حصر تسجيل الدخول على مستخدمين محددين حسب معرف Discord الخاص بهم. اتركه فارغًا لتعطيله.",
  ...
  "admin.config.oauth.discord-client-id": "معرّف عميل Discord",
  ...
  "admin.config.oauth.oidc-discovery-uri": "رابط اكتشاف OpenID Connect",
  ...
  "admin.config.oauth.oidc-username-claim": "مطالبة اسم المستخدم في OpenID Connect",
  "admin.config.oauth.oidc-username-claim.description": "مطالبة اسم المستخدم في رمز معرف OpenID Connect. إذا كنت لا تعرف معنى هذا الإعداد، اتركه فارغًا.",
  "admin.config.oauth.oidc-role-path": "مسار الأدوار في رمز OpenID Connect",
  "admin.config.oauth.oidc-role-path.description": "يجب أن يكون مسار JMES صالحًا يشير إلى مصفوفة من الأدوار. إدارة حقوق الوصول باستخدام أدوار OpenID Connect موصى بها فقط إذا لم يتم تكوين موفر هوية آخر وتعطيل تسجيل الدخول بكلمة السر. اتركه فارغًا إذا كنت لا تعرف ما هو هذا الإعداد.",
  "admin.config.oauth.oidc-role-general-access": "دور OpenID Connect للوصول العام",
  "admin.config.oauth.oidc-role-general-access.description": "الدور المطلوب للوصول العام. يجب أن يكون موجودًا في أدوار المستخدم لتسجيل الدخول. اتركه فارغًا إذا كنت لا تعرف ما هو هذا الإعداد.",
  "admin.config.oauth.oidc-role-admin-access": "دور OpenID Connect للوصول الإداري",
  "admin.config.oauth.oidc-role-admin-access.description": "الدور المطلوب للوصول الإداري. يجب أن يكون موجودًا في أدوار المستخدم للوصول إلى لوحة الإدارة. اتركه فارغًا إذا كنت لا تعرف ما هو هذا الإعداد.",
  "admin.config.oauth.oidc-client-id": "معرّف عميل OpenID Connect",
  "admin.config.oauth.oidc-client-id.description": "معرف العميل لتطبيق OpenID Connect OAuth",
  "admin.config.oauth.oidc-client-secret": "الرمز السري لعميل OpenID Connect",
  "admin.config.oauth.oidc-client-secret.description": "الرّمز السرّي للعميل لتطبيق OpenID Connect OAuth",
  "admin.config.category.ldap": "LDAP",
  "admin.config.ldap.enabled": "تفعيل LDAP",
  "admin.config.ldap.enabled.description": "استخدام مصادقة LDAP لتسجيل دخول المستخدم",
  "admin.config.ldap.url": "رابط الخادم",
  "admin.config.ldap.url.description": "رابط خادم LDAP",
  "admin.config.ldap.bind-dn": "ربط DN",
  "admin.config.ldap.bind-dn.description": "المستخدم الافتراضي المستخدم لإجراء بحث المستخدم",
  "admin.config.ldap.bind-password": "كلمة سر الربط",
  "admin.config.ldap.bind-password.description": "كلمة السر المستخدمة لإجراء بحث المستخدم",
  "admin.config.ldap.search-base": "قاعدة المستخدم",
  "admin.config.ldap.search-base.description": "الموقع الأساسي، حيث سيتم إجراء بحث المستخدم",
  "admin.config.ldap.search-query": "استعلام المستخدم",
  "admin.config.ldap.search-query.description": "سيتم استخدام استعلام المستخدم للبحث في 'قاعدة المستخدم' عن مستخدم LDAP. يمكن استخدام %username% كعنصر نائب للإدخال المعطى من المستخدم.",
  "admin.config.ldap.admin-groups": "مجموعة المدير",
  "admin.config.ldap.admin-groups.description": "المجموعة المطلوبة للوصول الإداري.",
  "admin.config.ldap.field-name-member-of": "اسم خاصية مجموعات المستخدم",
  "admin.config.ldap.field-name-member-of.description": "اسم خاصية LDAP للمجموعات التي يكون المستخدم عضوًا فيها. يُستخدم هذا عند التحقق من مجموعة المدير.",
  "admin.config.ldap.field-name-email": "اسم خاصية بريد المستخدم",
  "admin.config.ldap.field-name-email.description": "اسم خاصية LDAP لبريد المستخدم.",
  "admin.config.notify.success": "تم تحديث التكوين بنجاح.",
  "admin.config.notify.logo-success": "تم تحديث الشعار بنجاح. قد يستغرق الأمر بضع دقائق للتحديث على الموقع.",
  "admin.config.notify.no-changes": "لا توجد تغييرات للحفظ.",
  "admin.config.category.s3": "S3",
  "admin.config.s3.enabled": "مفعّل",
  "admin.config.s3.enabled.description": "ما إذا كان سيتم استخدام S3 لتخزين الملفات المشتركة بدلاً من نظام الملفات المحلي.",
  "admin.config.s3.endpoint": "نقطة النهاية",
  "admin.config.s3.endpoint.description": "رابط حاوية S3.",
  ...
  "admin.config.s3.key.description": "المفتاح الذي يسمح لك بالوصول إلى حاوية S3.",
  "admin.config.s3.secret": "السر",
  "admin.config.s3.secret.description": "السر الذي يسمح لك بالوصول إلى حاوية S3.",
  "admin.config.s3.use-checksum": "استخدام المجموع الاختباري",
  "admin.config.s3.use-checksum.description": "قم بإيقاف هذا للخوادم الخلفية التي لا تدعم المجموع الاختباري (مثل B2).",
  "admin.config.category.legal": "قانوني",
  "admin.config.legal.enabled": "تفعيل الإشعارات القانونية",
  "admin.config.legal.enabled.description": "ما إذا كان سيتم عرض رابط للطابع وسياسة الخصوصية في التذييل.",
  "admin.config.legal.imprint-text": "نص الطابع",
  "admin.config.legal.imprint-text.description": "النص الذي يجب عرضه في الطابع. يدعم Markdown. اتركه فارغًا للربط بصفحة طابع خارجية.",
  "admin.config.legal.imprint-url": "رابط الطابع",
  "admin.config.legal.imprint-url.description": "إذا كان لديك بالفعل صفحة طابع يمكنك ربطها هنا بدلاً من استخدام حقل النص.",
  "admin.config.legal.privacy-policy-text": "نص سياسة الخصوصية",
  "admin.config.legal.privacy-policy-text.description": "النص الذي يجب عرضه في سياسة الخصوصية. يدعم Markdown. اتركه فارغًا للربط بصفحة سياسة خصوصية خارجية.",
  "admin.config.legal.privacy-policy-url": "رابط سياسة الخصوصية",
  ...
  "error.msg.not_linked": "حساب {0} هذا لم يتم ربطه بأي حساب بعد.",
  ...
  "error.msg.cannot_get_user_info": "لا يمكن الحصول على معلومات المستخدم من حساب {0} هذا.",
  ...
  "common.text.or": "أو",
  "common.text.redirecting": "إعادة التوجيه...",
