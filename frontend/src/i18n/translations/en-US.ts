export default {
  ...
  "home.bullet.a.description": "Host Uplody on your own machine.",
  ...
  "admin.config.config-file-warning.description":
    "As you have a configured Uplody with a configuration file, you can't change the configuration through the UI.",
  ...
  "admin.config.general.app-url.description":
    "On which URL Uplody is available",
  ...
  "admin.config.cache.redis-enabled.description":
    "Normally Uplody caches information in memory. If you run multiple instances of Uplody, you need to enable Redis caching to share the cache between the instances.",
